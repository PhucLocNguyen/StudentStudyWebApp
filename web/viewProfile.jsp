    ...
    <body>
        ...
        <div class="bg-body-tertiary pt-3">
            <div class="container">
                ...
                <div class="row mt-3">
                    <div class="col-lg-12">
                        <img src="${requestScope.student.getThumbnail()}" class="rounded-circle d-block mx-auto" alt="..."
                             style="width: 12rem; height: 12rem; object-fit: cover;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 my-auto text-center">
                        <h1>${requestScope.student.getName()}</h1>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-8">
                        ...
                        <a href="insideClass?class_id=<%= item.getClasses().getId()%>" class="card rounded-4 text-decoration-none my-2" style="min-height: 5rem;">
                            <div class="card-body">
                                ...
                                <span class="badge rounded-pill text-bg-secondary my-1 me-3">Lecturer : <%= item.getClasses().getLecturer().getName()%></span>
                            </div>
                        </a>
                        <%
                                    }
                    ...
                    <div class="col-lg-4">
                        <div class="card rounded-4 my-2">
                            <div class="card-body fw-medium fs-3">
                                Number of courses : <%= size_class_enroll%>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="card rounded-4 my-2">
                            <div class="card-body fw-medium fs-3">
                                Number of classes : <%= size_class_enroll%>
                            </div>
                        </div>
                    </div>
