<%-- 
    Document   : creat_question
    Created on : Jan 24, 2024, 10:06:06 AM
    Author     : User
--%>
    ...
    <div class="container">
        <div class="row mt-2">
            ...
            <div class="col-lg-2 py-2 d-flex justify-content-around align-items-center">
                ...
                <form action="createClassForTeacher.jsp">
                    <input class="btn btn-primary" type="submit" value="Tao lop hoc">
                </form>
            ...
            <div class="row">
                <div class="py-4 bg-image-full rounded-4" style="background-image: url('./img/background.jpg')">
                    <div class="text-center">
                        <img class="img-fluid rounded-circle mb-3" src="./img/gumbal.jpg" alt="..."
                            style="height: 6rem;" />
                        <h1 class="text-white fs-3 fw-bolder">PRJ 301</h1>
                        <p class="text-white fw-medium mb-0">Ten cua giang vien lop hoc</p>
                    </div>
                </div>
            </div>

            <div class="row mt-3">
                <a href="insideCreateQuestion.jsp" class="btn btn-primary rounded-4 fw-bold px-5">Tao cau hoi</a>
            </div>
