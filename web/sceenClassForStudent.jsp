<%-- 
    Document   : sceenClassForStudent
    Created on : Jan 24, 2024, 10:08:40 AM
    Author     : User
--%>
    ...
    <div class="bg-body-tertiary pt-3">
        <div class="container">
            ...
            <div class="row my-3">
                ...
                <div class="col-lg-8">
                    <a href="sceenAnswerQuestion.jsp" class="card rounded-4 text-decoration-none my-2" style="min-height: 5rem;">
                        <div class="card-body">
