                            ...
                            <div class="card rounded-4">
                                <form accept-charset="UTF-8" action="createQuestion" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <label class="form-label fs-5 fw-medium">Question title</label>
                                        <input type="text" class="form-control" placeholder="Enter the name of the class" name="title" value="${requestScope.title}">
                                        <div>
                                            <p class="form-label fs-5 fw-medium">Describe</p>
                                            <textarea id="froala-editor" class="form-control" rows="3" 
                                                      placeholder="Add a description to your class" name="description">${requestScope.description}</textarea>
                                        </div>

                                        <div>
                                            <p class="form-label fs-5 fw-medium">Attachments</p>
                                        ...
                                        <div id="time_container" class="">
                                            <label class="form-label fs-5 fw-medium">Open date : </label>
                                            <input id="time-input" name="start_time" type="datetime-local" class="form-control" value="${requestScope.start_date}">

                                            <label class="form-label fs-5 fw-medium">Closing date :</label>
