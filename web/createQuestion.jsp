                        ...
                        <div class="card rounded-4">
                            <form accept-charset="UTF-8" action="createQuestion" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhap ten cua lop hoc" name="title" value="${requestScope.title}" required>
                                    <div>
                                    ...
                                    <div id="time_container" class="${requestScope.status eq "pending"?'d-none':''}">
                                        ...
                                        <label class="form-label fs-5 fw-medium">End date:</label>
