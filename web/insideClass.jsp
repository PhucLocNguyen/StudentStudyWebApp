        ...
        <div class="container" id="headerContainer">
            ...
            <div class="bg-body-tertiary pt-3">
                <div class="container">
                    ...
                    <div class="row mt-3">
                        <a href="createQuestion.jsp?class_id=<%=getClass.getId()%>" class="btn btn-primary rounded-4 fw-bold px-5">Create Exercise</a>
                    </div>
                            ...
                            <div class="exercise-container" >
                                ...
                                <div class="more-options" >
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="createQuestion?action=delete&classId=<%=getClass.getId()%>&exercise_id=<%=exc.getExerciseID()%>" class="dropdown-item dropdown-item-delete">Delete</a> 
