                ...
                <div class="bg-body-tertiary pt-3">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="py-4 bg-image-full rounded-top-4" style="background-repeat: no-repeat;
                                 background-size: cover; background-image: url('<%=getClass.getThumbnail()%>')">
                            ...
                            <div class="mx-auto py-2 text-center" style="background-color: white;" >
                                <h1 class="text-dark fs-3 fw-bolder"><%=getClass.getName()%></h1>
                                <p class="text-dark fw-medium mb-0"><%=getClass.getLecturer().getName()%></p>  
                            </div>
                        </div>

                        <%  if (getRole != null && getRole.equals("lecturer")) {%>
                        <div class="row mt-3">
                            <a href="createQuestion.jsp?class_id=<%=getClass.getId()%>" class="btn btn-primary rounded-4 fw-bold px-5">Create questions</a>
                        </div>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="exercise-container" >
                                    <a href="<%="exerciseView?exercise_id=" + exc.getExerciseID() + "&class_id=" + exc.getClasses().getId()%>" class="card rounded-4 text-decoration-none my-2 student_exercise" style="min-height: 5rem;">
                                        <div class="card-body">
                                            <h5 class="card-title fs-3"> <%= exc.getTitle()%> </h5>
                                            <% if (exc.getStatus().equals("active")) {%>
                                            <span class="badge rounded-pill text-bg-success my-1 me-3" >Status : <%= exc.getStatus()%></span>
                                            <% } else if (exc.getStatus().equals("inactive")) {%>
                                            <span class="badge rounded-pill text-bg-danger my-1 me-3" >Status : <%= exc.getStatus()%></span>
                                            <% } else {%>
                                            <span class="badge rounded-pill text-bg-warning my-1 me-3" >Status : <%= exc.getStatus()%></span>
                                            <% }%>
                                            <% if (!exc.getStatus().equals("pending") && (exc.getStartDate() != null && exc.getEndDate() != null)) {%>
                            ...
                            <div class="col-lg-4">
                                <div class="card mt-2 rounded-4">
                                    <div class="card-body" style="min-height: 20rem;"> 
                                        ...
                                        <a class="text-decoration-none text-dark fs-5 fw-medium" href="#">Participants: <%= participants%></a>
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <a href="answerquestion?class_id=<%= getClass.getId()%>&exercise_id=<%= exc.getExerciseID()%>&action=" data-status="<%=exc.getStatus()%>" class="card rounded-4 text-decoration-none my-2 student_exercise" style="min-height: 5rem;">
                                    <div class="card-body">
                                        ...
                                        <%
                                            if (exc.getStartDate() != null || exc.getEndDate() != null) {
                                        %>
                                        <span class="badge rounded-pill text-bg-secondary my-1 me-3">From : <%= exc.getStartDate()%></span>
                                        <span class="badge rounded-pill text-bg-secondary my-1">To : <%= exc.getEndDate()%></span>
                                        <%}%>
                            ...
                            <div class="col-lg-4">
                                <div class="card mt-2 rounded-4">
                                    <div class="card-body" style="min-height: 20rem;"> 
                                        <h5 class="card-title fs-3 fw-bolder">Classroom Information</h5>
                                        <a class="text-decoration-none text-dark fs-5 fw-medium" href="viewprofile?action=showlist&classid=<%=getClass.getId()%>">Number of participants: <%= participants%></a>
